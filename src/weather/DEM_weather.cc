...
int run_weather_test(
  ...
  model.intermediate_expectations_filename =
      "data/climate_no_co2/" + scenario + "/param_expectations.csv";
  model.intermediate_covariances_filename =
      "data/climate_no_co2/" + scenario + "/param_covariances.csv";
  ...
  param_expectations_file.open("data/climate_no_co2/" + scenario +
                               "/param_expectations.csv");
  std::string param_expectations_line;
  std::ifstream param_covariances_file;
  param_covariances_file.open("data/climate_no_co2/" + scenario +
  ...
  utility::print_matrix("data/climate_no_co2/" + scenario + "/true_generative.csv",
                        true_out);
  utility::print_matrix("data/climate_no_co2/" + scenario + "/prior_generative.csv",
                        prior_e_out);
  utility::print_matrix("data/climate_no_co2/" + scenario + "/prior_generative_rand.csv",
                        prior_rand_out);
  utility::print_matrix("data/climate_no_co2/" + scenario + "/pos_generative.csv",
                        posterior_e_out);
  utility::print_matrix("data/climate_no_co2/" + scenario + "/pos_generative_rand.csv",
                        posterior_rand_out);
  return 0;
}
